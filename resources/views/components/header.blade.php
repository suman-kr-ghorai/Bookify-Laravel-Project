...
<nav class="flex flex-wrap items-center justify-between bg-gray-100">
    ...
    <div class="toggle hidden w-full md:w-auto md:flex gap-6 text-right font-bold mt-5 md:mt-0 md:border-none">
        <a href="/" class="flex items-center justify-center w-full px-4 py-4 text-xl font-bold capitalize duration-100 transform border-2 rounded-xl cursor-pointer focus:ring-4 focus:ring-gray-400 focus:ring-opacity-50 focus:outline-none sm:w-auto sm:px-6 border-text hover:shadow-lg hover:-translate-y-1">
            <i class="fas fa-home mr-2"></i> Home
        </a>
        <a href="/booking" class="flex items-center justify-center w-full px-4 py-4 text-xl font-bold capitalize duration-100 transform border-2 rounded-xl cursor-pointer focus:ring-4 focus:ring-gray-400 focus:ring-opacity-50 focus:outline-none sm:w-auto sm:px-6 border-text hover:shadow-lg hover:-translate-y-1">
    ...
    <div class="toggle w-full text-end hidden md:flex md:w-auto px-2 py-2 md:rounded">
        <div class="flex items-center h-10 w-30 rounded-md bg-gray-100 font-medium p-2">
            <div class="flex space-x-4">
                @if (session('user_id'))
                    <a href="/my-tickets" class="flex items-center justify-center w-full px-4 py-4 text-xl font-bold capitalize duration-100 transform border-2 cursor-pointer focus:ring-4 focus:ring-black focus:ring-opacity-50 focus:outline-none sm:w-auto sm:px-6 border-text hover:shadow-lg hover:-translate-y-1 rounded-xl">
                        <i class="fas fa-receipt mr-2"></i> My Tickets
                    </a>
                    <a href="#profile" class="px-5 py-5 text-white font-medium rounded-3xl hover:bg-blue-400 transition duration-200 bg-gray-300">
                    ...
                    <a href="/logout" class="px-5 py-5 bg-red-500 text-white font-medium rounded-3xl hover:bg-red-600 transition duration-200">
